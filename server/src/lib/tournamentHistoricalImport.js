// Parses uploaded historical tournament spreadsheets (xlsx or csv) into rows
// ready to insert. Direct port of golfHistoricalImport.js — already
// sport-agnostic column-alias matching, so this is a copy with zero
// behavioral changes beyond the recommended-format copy string. Two
// independent lists — players (grouped into teams) and sponsors — same
// split as raffleHistoricalImport.js's single-list equivalent, doubled.
//
...
//  - tournamentHistoricalImportAi.js's extractPlayersFromRows/
//    extractSponsorsFromRows handle everything else, for a file that
//    doesn't match any recognized shape — always reviewed before anything
//    commits, same as this app's other AI-assisted features.
