...
// this year's. Direct port of golfKickoffEmail.js, generalized off "golf":
// table-based/inline-style (email clients don't render flexbox, CSS
// variables, or web fonts), themed with the org's own flyer colors, same
// dark-hero/checkmark-included-items/schedule-timeline/dark-contact-block
// visual language the flyer and public page already share.
//
...
function tournamentKickoffEmailHtml({ org, tournament, registerUrl, recipientFirstName, unsubscribeUrl }) {
      ...
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;background:#faf8f2;border-radius:10px;overflow:hidden;">
        ...
        <tr><td style="background:${primary};padding:22px 32px;text-align:center;">
          ...
          <div style="font-size:10.5px;color:#ffffff;opacity:0.65;margin-top:14px;line-height:1.6;">
            You're receiving this because you've played in a past ${org.name || "our"} tournament.<br>
...
module.exports = { tournamentKickoffEmailHtml };
