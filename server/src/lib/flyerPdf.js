...
//
// The shared flyer renderer for every module that prints one (Events, Raffle,
// Tournaments) — buildEventFlyerPdf() takes a plain content shape, and each
// module owns its own small mapping from its record to that shape (see
// eventFlyerPdf.js, raffleFlyerPdf.js, tournamentFlyerPdf.js).
const fs = require("fs");
...
module.exports = { buildEventFlyerPdf };
